...
func (x *RestockRequest) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
func (x *RestockResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *RestockResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_inventory_proto_rawDesc = "" +
	...
	"\x0eRestockRequest\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity\"E\n" +
	"\x0fRestockResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	...
	"\rDeleteProduct\x12\x1f.inventory.DeleteProductRequest\x1a .inventory.DeleteProductResponse\x12E\n" +
	"\fRestockItems\x12\x19.inventory.RestockRequest\x1a\x1a.inventory.RestockResponseB9Z7github.com/faysal/micro-service/inventory-service/protob\x06proto3"
...
var file_inventory_proto_goTypes = []any{
	...
	(*RestockRequest)(nil),        // 15: inventory.RestockRequest
	(*RestockResponse)(nil),       // 16: inventory.RestockResponse
}
var file_inventory_proto_depIdxs = []int32{
	...
	15, // 8: inventory.InventoryService.RestockItems:input_type -> inventory.RestockRequest
	1,  // 9: inventory.InventoryService.ReserveStock:output_type -> inventory.ReserveResponse
	3,  // 10: inventory.InventoryService.ReleaseStock:output_type -> inventory.ReleaseResponse
	5,  // 11: inventory.InventoryService.GetStock:output_type -> inventory.GetStockResponse
	8,  // 12: inventory.InventoryService.ListProducts:output_type -> inventory.ListProductsResponse
	10, // 13: inventory.InventoryService.CreateProduct:output_type -> inventory.CreateProductResponse
	12, // 14: inventory.InventoryService.UpdateProduct:output_type -> inventory.UpdateProductResponse
	14, // 15: inventory.InventoryService.DeleteProduct:output_type -> inventory.DeleteProductResponse
	16, // 16: inventory.InventoryService.RestockItems:output_type -> inventory.RestockResponse
