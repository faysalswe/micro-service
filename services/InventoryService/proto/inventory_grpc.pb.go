...
type InventoryServiceClient interface {
	...
	RestockItems(ctx context.Context, in *RestockRequest, opts ...grpc.CallOption) (*RestockResponse, error)
}
...
func (c *inventoryServiceClient) RestockItems(ctx context.Context, in *RestockRequest, opts ...grpc.CallOption) (*RestockResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type InventoryServiceServer interface {
	...
	RestockItems(context.Context, *RestockRequest) (*RestockResponse, error)
...
func (UnimplementedInventoryServiceServer) RestockItems(context.Context, *RestockRequest) (*RestockResponse, error) {
...
func _InventoryService_RestockItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).RestockItems(ctx, req.(*RestockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
